package com.pelotcl.app.transport.lyontcl.ui.theme
...
/**
 * Implémentation du thème pour Lyon TCL
 * Couleurs officielles du réseau TCL
 */
@Immutable
class LyonTclTheme : TransportTheme {
    
    // Couleurs officielles TCL
    override val primaryColor: Color = Color(0xFFE60000) // Rouge TCL
    override val secondaryColor: Color = Color(0xFF000000) // Noir
    override val accentColor: Color = Color(0xFFFFFFFF) // Blanc
    
    // Couleurs par type de transport (officielles TCL)
    override val metroLineColor: Color = Color(0xFFE60000) // Rouge métro
    override val tramLineColor: Color = Color(0xFF007AC3) // Bleu tramway
    override val busLineColor: Color = Color(0xFF00A651) // Vert bus
     ...
     * Gère les cas spécifiques des lignes TCL
     */
    @Composable
