package com.pelotcl.app.core.data.repository.online
        ...
        return callbackFlow {
            ...
            val listener = object : EventSourceListener() {
                override fun onOpen(eventSource: EventSource, response: Response) {
                    Log.d("VehiclePositionsRepo", "SSE connected to api.dotshell.eu")
                    Log.d(
                        "DotshellRequest",
                ...
                override fun onEvent(
                    ...
                    if (type == "heartbeat") {
                        Log.d("DotshellRequest", "[SSE] Heartbeat received")
                        return
                    }
                ...
                override fun onClosed(eventSource: EventSource) {
                    Log.d("DotshellRequest", "[SSE] Connection closed")
                    close()
                }
            ...
            if (attempt >= 10) {
                Log.e("VehiclePositionsRepo", "Max retries reached, giving up")
